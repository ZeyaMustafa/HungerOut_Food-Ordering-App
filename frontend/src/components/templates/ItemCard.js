    ...
    return (
        <Card style={{
            ...
            <CardContent>
                ...
                {vendor !== "" ?
                    <Typography  color="textSecondary" component="h2" gutterBottom variant="h6" style={{fontWeight:'bold'}}>
                        {vendor.shop_name}
                    </Typography>
                    :
                    null
                ...
                {item.tags.length > 0 &&
                    <div>
                        ...
                        { user_type() === 'buyer' &&
                            ...
                            <h6>{`Seats At Restaurant: ${vendor.seats}`}</h6>
                            </Typography>
                        }
                        

                    {vendor.seats==='Available' && user_type() === 'buyer' && 
                    <Typography variant="body2" color="textSecondary" component="p">
                        {`Call Us at ${vendor.number} To Reserve Seats`}
                    </Typography>
                    }
