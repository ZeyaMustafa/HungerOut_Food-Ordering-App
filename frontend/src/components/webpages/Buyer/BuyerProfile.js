...
const BuyerProfile = () => {
    ...
    const validateUserDetails = () => {
        if (userDetails.name === '' ||userDetails.name.match(/[^a-zA-Z ]{2,40}$/)|| userDetails.email === '' || userDetails.number === '' || userDetails.age === '' || error.email || error.age ||userDetails.address==='') {
            Swal.fire({
                title: 'Error',
                    ...
                    <TableContainer component={Paper} style={{ marginTop: '1.5rem' }}>
                        <Table aria-label="simple table">
                            <TableBody>
                                ...
                                >
                                    <TableCell component="th" scope="row">
                                        <MapRoundedIcon style={{ marginRight: "0.5rem", fontSize: "1rem" }} />Batch
                                    </TableCell>
                                    <TableCell align="right">
                                        {originalUser.batch}
                                    </TableCell>
                                ...
                                >
                                    <TableCell component="th" scope="row">
                                        <HomeRoundedIcon style={{ marginRight: "0.5rem", fontSize: "1rem" }} />Address
                                    </TableCell>
                                    <TableCell align="right">
